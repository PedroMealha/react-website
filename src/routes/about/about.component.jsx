...
const About = () =>
	<div className="about">
		...
		<div className="intro">
			...
			<br />
			<p>I also have some experience on <span>Vue.js</span> and i started learning <span>React.js</span> due to high demand of the frontend's tech requirements - <span>including</span> Redux, Unit Testing, GraphQL, Firebase and Cloud Firestore with a final project of a fully functional online web store.</p><br />
